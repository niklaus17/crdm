...
if(isset($_POST['btn-upload']))
{
  ...
  $name = $_SESSION['user']['username'];
 	...
 	$sql="INSERT INTO formular_4(director4, data4, chek1_4, institutia, locatia, numar_inventar4, data_non, producator, anul_producerii, nume_dispozitiv4, model, numar_serie, numar_inventar2_4, uzura, data_exploatare,
    termen, pret, valoarea, descrierea, cauza, nota, beneficiar4, contabil, it, inginer1_4, inginer2_4, inginer3_4, name)

        VALUES('$director4','$data4', '$chek1_4', '$institutia', '$locatia', '$numar_inventar4', '$data_non', '$producator', '$anul_producerii', '$nume_dispozitiv4', '$model', '$numar_serie', '$numar_inventar2_4', '$uzura',
