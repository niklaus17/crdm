...
if(isset($_POST['btn-upload']))
{
  ...
  $name = $_SESSION['user']['username'];
 	...
 	$sql="INSERT INTO formular_2(director2, cabinet2, section_id, executor2, data2, nume_dispozitiv2, anul_producerii_dispozitiv2, model_dispozitiv2, nr_serie_dispozitiv2,
    producator_dispozitiv2, numar_inventar2, desc_defect, cauza_defect, actiuni, data_instalarii2, ore, chek, materiale, comentarii2, beneficiar2, inginer1, inginer2, inginer3, name)
        ...
        VALUES('$director2', '$cabinet2', '$section_id', '$executor2', '$data2', '$nume_dispozitiv2', '$anul_producerii_dispozitiv2', '$model_dispozitiv2', '$nr_serie_dispozitiv2',
          '$producator_dispozitiv2', '$numar_inventar2', '$desc_defect', '$cauza_defect', '$actiuni', '$data_instalarii2', '$ore', '$chek', '$materiale', '$comentarii2', '$beneficiar2', '$inginer1', '$inginer2', '$inginer3', '$name')";
