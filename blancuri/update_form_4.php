...
if(isset($_POST['btn-update_4']))
{
  ...
  $query = "UPDATE formular_4 SET director4='$director4', data4='$data4', chek1_4='$chek1_4', institutia='$institutia', locatia='$locatia', numar_inventar4='$numar_inventar4', data_non='$data_non',
