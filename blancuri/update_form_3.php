...
if(isset($_POST['btn-update_3']))
{
  ...
  $query = "UPDATE formular_3 SET cabinet3='$cabinet3', section_id='$section_id', executor3='$executor3', nume_dispozitiv3='$nume_dispozitiv3', anul_producerii_dispozitiv3='$anul_producerii_dispozitiv3',
  model_dispozitiv3='$model_dispozitiv3', nr_serie_dispozitiv3='$nr_serie_dispozitiv3', producator_dispozitiv3='$producator_dispozitiv3', numar_inventar3='$numar_inventar3',
  data_proc='$data_proc', data_inst='$data_inst', chek1_3='$chek1_3', respons='$respons', chek2_3='$chek2_3', luni3='$luni3',  comentarii3='$comentarii3', beneficiar3='$beneficiar3',
  inginer1_3='$inginer1_3', inginer2_3='$inginer2_3', inginer3_3='$inginer3_3', name='$name' where id='$id' ";
